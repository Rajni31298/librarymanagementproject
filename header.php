...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="http://localhost/library_management_system/asset/css/simple-datatables-style.css" rel="stylesheet" />
        <link href="http://localhost/library_management_system/asset/css/styles.css" rel="stylesheet" />
        <script src="http://localhost/library_management_system/asset/js/font-awesome-5-all.min.js" crossorigin="anonymous"></script>
        <!-- Favicons -->
